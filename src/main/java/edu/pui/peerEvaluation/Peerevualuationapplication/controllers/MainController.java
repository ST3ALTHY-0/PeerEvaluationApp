...
public class MainController {
    ...
    @Autowired
    public MainController(UserService userService, OAuth2Service oAuth2Service, EvaluationService evaluationService, ProjectGroupService projectGroupService, StudentService studentService){
    ...
    public String studentCompleteEvaluation(@AuthenticationPrincipal OAuth2User principal, Model model, @RequestParam("evaluationId") int evaluationId) {
